...
func authMiddleware(authService auth.Service, userService user.Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		//auth header value -> "Bearer tokentokentoken"
		tokenString := ""
...
// validasi token
// jika valid lanjutkan, ambil user id
// ambil user dari db berdasarkan user id di service dan repo
// set user context dengan isinya user
